...
const AddVideo = () => {
  ...
  const handleSubmit = () => {
    ...
    if (!isValid) {
      alert(
        "Please fill in all required fields: Title, Author, Video Link, Thumbnail."
      );
      return;
    }
  ...
  return (
    <Flex justifyContent={'center'} alignItems={'center'}>
      <Box
        ...
        mt={4}
        // width={"60%"}
        border={"1px solidrgb(224, 222, 222)"}
        boxShadow={"5px 5px 5px 2px #808080"}
        borderRadius={"6px"}
      >
        <Text fontSize="24px" fontStyle={'italic'} mb={2} textAlign={'center'} textTransform={"uppercase"}>
          Add new video
        </Text>
